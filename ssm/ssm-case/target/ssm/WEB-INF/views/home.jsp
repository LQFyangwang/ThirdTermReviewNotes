...
<body class="easyui-layout">
    ...
    <div id="top" data-options="region:'north'">
        ...
        <div id="welcome">
            欢迎您：<a href="#">admin@126.com</a>,&nbsp;<a href="<%=path %>/user/logout">安全退出</a>
        </div>
    </div>
    ...
    <div id="menu" data-options="region:'west',split:true" title="主菜单">
        <div class="easyui-accordion">
            <div title="现金流水管理" data-options="iconCls:'icon-ok',selected:true">
                <ul>
                    <li><a href="javascript:void(0);" class="site-navi-tab" data-src="<%=path %>/cash/page">所有流水</a></li>
                </ul>
            </div>
            <div title="日志管理" data-options="iconCls:'icon-help'">
                <ul>
                    <li><a href="javascript:void(0);" class="site-navi-tab" data-src="<%=path %>/login_log/page">登录日志</a></li>
                </ul>
            </div>
        </div>
    </div>
